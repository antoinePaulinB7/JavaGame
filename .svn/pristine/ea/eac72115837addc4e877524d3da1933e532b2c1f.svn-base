	...
	public PanelAide() {
		...
		txtpnQuteVersLinfini.setText("Qu\u00EAte vers l\u2019infini est un jeu de type platformer qui permet \u00E0 un ou deux joueurs d\u2019explorer un monde infini g\u00E9n\u00E9r\u00E9 de fa\u00E7on proc\u00E9durale, de combattre des monstres, d\u2019acqu\u00E9rir des tr\u00E9sors et de gagner de l\u2019exp\u00E9rience pour monter de niveau. Pour toute question sur une des fonctionnalit\u00E9s, r\u00E9f\u00E9rez-vous \u00E0 l\u2019arbre ci-dessous.");
				...
				txtpncranPartag.setText("\u00C9cran partag\u00E9"
						...
						+"Système de combat"
						+"\n"
						+"Le système de combat permet l'interaction entre les joueurs et les monstres. Grâce au système, il est possible d'attaquer, de bloquer des coups, de faire des attaques propulsées et des attaques spéciales. Tout cela est démontré par des animations."
						+"\n"+"\n"
						+"Quêtes infinies"
						+"\n"
						+"Des quêtes autogénérées à l'infini procurent aux joueurs des objectifs interactifs avec le monde."
						+"\n"+"\n"
						+"Contrôles personnalisés"
						+"\n"
						+"Les joueurs peuvent choisir des contrôles personnalisés pour jouer à leur façon et ces contrôles sont conservés avec les sauvegarde et sont modifiables n'importe quand."
						+"\n"+"\n"
						+"Système de «Hand tracking»"
						+"\n"
						+"Ce système permet de mettre des objets différents dans les mains des personnages sans avoir à dessiner chaque image pour chaque personnage avec chaque arme."
						);
