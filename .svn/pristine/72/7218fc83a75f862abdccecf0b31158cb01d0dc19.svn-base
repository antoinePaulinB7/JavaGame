	...
	public MenuPause(Monde monde) {
		...
		btnRetournerAuMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int n = JOptionPane.showOptionDialog(null, "Êtes-vous sûr de vouloir retourner au menu principal sans sauvegarder?", "Retour au menu principal",
		...
		btnQuitter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int n = JOptionPane.showOptionDialog(null, "Êtes-vous sûr de vouloir quitter sans sauvegarder?", "Quitter",
						JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
				switch (n) {
				case 0 : 
					if (sauvegarder())
